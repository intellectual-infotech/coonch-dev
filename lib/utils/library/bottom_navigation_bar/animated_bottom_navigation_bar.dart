...
import 'package:coonch/utils/library/bottom_navigation_bar/src/around_custom_painter.dart';
import 'package:coonch/utils/library/bottom_navigation_bar/src/circular_notch_and_corner_clipper.dart';
import 'package:coonch/utils/library/bottom_navigation_bar/src/circular_notched_and_cornered_shape.dart';
import 'package:coonch/utils/library/bottom_navigation_bar/src/exceptions.dart';
import 'package:coonch/utils/library/bottom_navigation_bar/src/gap_item.dart';
import 'package:coonch/utils/library/bottom_navigation_bar/src/navigation_bar_item.dart';
import 'package:coonch/utils/library/bottom_navigation_bar/src/safe_area_values.dart';
import 'package:coonch/utils/library/bottom_navigation_bar/src/visible_animator.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
// import 'package:week_challenge/core/utils/library/bottom_navigation_bar/src/around_custom_painter.dart';
// import 'package:week_challenge/core/utils/library/bottom_navigation_bar/src/circular_notch_and_corner_clipper.dart';
// import 'package:week_challenge/core/utils/library/bottom_navigation_bar/src/circular_notched_and_cornered_shape.dart';
// import 'package:week_challenge/core/utils/library/bottom_navigation_bar/src/exceptions.dart';
// import 'package:week_challenge/core/utils/library/bottom_navigation_bar/src/gap_item.dart';
// import 'package:week_challenge/core/utils/library/bottom_navigation_bar/src/navigation_bar_item.dart';
// import 'package:week_challenge/core/utils/library/bottom_navigation_bar/src/safe_area_values.dart';
// import 'package:week_challenge/core/utils/library/bottom_navigation_bar/src/visible_animator.dart';
...
class AnimatedBottomNavigationBar extends StatefulWidget {
  AnimatedBottomNavigationBar({
    required List<String> imageIcons,
  ...
  AnimatedBottomNavigationBar._internal({
    ...
    if (gapLocation == GapLocation.center) {
      final iconsCountIsOdd = (itemCount ?? imageIcons!.length).isOdd;
      if (iconsCountIsOdd) {
        throw NonAppropriatePathException(
  ...
  /// Image data to render in the tab bar.
  final List<String>? imageIcons;

  /// Icon Names to render in the tab bar.
...
class _AnimatedBottomNavigationBarState
  ...
  List<Widget> _buildItems() {
    ...
    final gapItemWidth = widget.notchAndCornersAnimation != null
        ...
        : gapWidth;
    final itemCount = widget.itemCount ?? widget.imageIcons!.length;
    ...
    for (var i = 0; i < itemCount; i++) {
      ...
      items.add(
        NavigationBarItem(
          ...
          imageData: widget.imageIcons?.elementAt(i),
          iconName: widget.tabNames!.elementAt(i),
